...
float3 rgbNW = tex2D(_MainTex, i.texcoord.xy + (float2(-1.0, -1.0) * texcoordOffset)).xyz;
float3 rgbNE = tex2D(_MainTex, i.texcoord.xy + (float2(+1.0, -1.0) * texcoordOffset)).xyz;
float3 rgbSW = tex2D(_MainTex, i.texcoord.xy + (float2(-1.0, +1.0) * texcoordOffset)).xyz;
float3 rgbSE = tex2D(_MainTex, i.texcoord.xy + (float2(+1.0, +1.0) * texcoordOffset)).xyz;
float3 rgbM  = tex2D(_MainTex, i.texcoord.xy).xyz;
