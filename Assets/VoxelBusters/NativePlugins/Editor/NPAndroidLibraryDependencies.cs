...
namespace VoxelBusters.NativePlugins
{
	...
	public class NPAndroidLibraryDependencies
	{
		...
		private static readonly string SupportLibsVersionString		=	"LATEST";//26.0.1+ is must as we need to use NotificationCompat for Oreo and Up devices - wehn targetting >= 26
#else
